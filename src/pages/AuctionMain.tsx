...
import { useAllAuctions } from "@/hooks/auction/useAllAuctions";
...
export default function AuctionMain() {
  const { isConnected, switchToSepolia, chainId } = useWallet();
              ...
              <TabsContent value="active" className="mt-6">
                ...
                {isLoading ? (
                  ...
                  <motion.div
                    ...
                    className="text-center py-16 bg-muted rounded-lg border border-dashed"
                  >
